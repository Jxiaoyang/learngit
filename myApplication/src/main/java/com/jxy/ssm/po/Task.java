...
public class Task {
	...
	private String task_pricontent;//隐私任务内容
	...
	public String toString() {
		return "Task [task_id=" + task_id + ", task_type=" + task_type + ", task_name=" + task_name + ", task_content="
				+ task_content + ", task_pricontent=" + task_pricontent + ", task_people=" + task_people
				+ ", task_money=" + task_money + ", task_receive=" + task_receive + ", task_accomplish="
				+ task_accomplish + ", task_taskTime=" + task_taskTime + ", task_putID=" + task_putID + "]";
	}
	public Task(int task_id, int task_type, String task_name, String task_content, String task_pricontent,
